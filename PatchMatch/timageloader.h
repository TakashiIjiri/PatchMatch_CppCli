...
inline bool t_loadImage(System::String ^fname, System::Drawing::Bitmap^ bmp)
{
	System::Drawing::Image^ img  = System::Drawing::Image::FromFile( fname );
	 bmp  = gcnew System::Drawing::Bitmap(img);
...
{
	bmp = gcnew System::Drawing::Bitmap(W,H, System::Drawing::Imaging::PixelFormat::Format32bppRgb);
